...
class Main():
    ...
    def MainMenu(self):
        ...
        self.Title_lbl = TK.Label(self.MainMenu_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Main Menu...")
        self.Title_lbl.grid(row=0, column=0, sticky="nsew", padx=10, pady=2)

        self.Settings_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                      foreground=self.Foreground, font=self.Font, text="Settings", command=lambda: self.Settings())
        self.Settings_btn.grid(row=0, column=1, sticky="nsew", padx=2, pady=2)

        self.Help_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="?", command=lambda: self.MainMenu_Help())
        self.Help_btn.grid(row=0, column=2, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.MainMenu_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, columnspan=3,
                            sticky="nsew", padx=2, pady=2)
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                self.Cur.execute(
                    "SELECT Warnings FROM Users WHERE Username = ?", ((self.Username, )))
        ...
        try:
            ...
            if int(self.Warnings) > 0:
                self.Space_lbl.config(
                    text="You have: {Num} Warnings".format(Num=self.Warnings))

            if int(self.Warnings) >= 3:
                self.Warnings_lbl = TK.Label(self.MainMenu_fr, bg=self.Background, font=self.Font, foreground=self.Foreground,
                                             text="You has reached three warnings\nYour account will now be deleted for these violations")
                self.Warnings_lbl.grid(
                    row=2, column=0, columnspan=2, padx=2, pady=2, sticky="nsew")

                self.OK_btn = TK.Button(self.MainMenu_fr, command=lambda: self.DeleteAccount(
                    self.MainMenu_fr), bg=self.Btn_Background, activebackground=self.Btn_Active, foreground=self.Foreground, font=self.Font, text="Continue")
                self.OK_btn.grid(row=3, column=0, padx=2,
                                 pady=2, columnspan=3, sticky="nsew")
        ...
        self.Tools_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, foreground=self.Foreground,
                                   activebackground=self.Btn_Active, font=self.Font, text="Tools", command=lambda: self.ToolsMenu())
        self.Tools_btn.grid(row=2, column=0, columnspan=3,
                            padx=2, pady=2, sticky="nsew")

        self.Games_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, foreground=self.Foreground,
                                   activebackground=self.Btn_Active, font=self.Font, text="Games", command=lambda: self.GamesMenu())
        self.Games_btn.grid(row=3, column=0, columnspan=3,
                            padx=2, pady=2, sticky="nsew")

        self.Message_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, foreground=self.Foreground,
                                     activebackground=self.Btn_Active, font=self.Font, text="View Messages", command=lambda: self.Messages())
        self.Message_btn.grid(row=4, column=0, columnspan=3,
                              padx=2, pady=2, sticky="nsew")
        ...
        if self.AccountType == "admin" or self.AccountType == "owner":
            self.AdminMenu_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                           font=self.Font, foreground=self.Foreground, text="Admin Menu", command=lambda: self.AdminMenu())
            self.AdminMenu_btn.grid(
                row=5, column=0, columnspan=3, padx=2, pady=2, sticky="nsew")

        if self.AccountType == "owner":
            self.OwnerMenu_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                           font=self.Font, foreground=self.Foreground, text="Owner Menu", command=lambda: self.OwnerMenu())
            self.OwnerMenu_btn.grid(
                row=6, column=0, columnspan=3, padx=2, pady=2, sticky="nsew")

        self.QUIT_btn = TK.Button(self.MainMenu_fr, bg=self.QuitBtn_Background, activebackground=self.QuitBtn_Active,
        ...
        self.Logout_btn = TK.Button(self.MainMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                    foreground=self.Foreground, font=self.Font, text="Logout", command=lambda: self.Back(self.MainMenu_fr, 0))
        self.Logout_btn.grid(row=7, column=1, columnspan=2,
                             padx=2, pady=2, sticky="nsew")
    ...
    def Settings(self):
        ...
        self.Title_lbl = TK.Label(self.Settings_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Settings:")
        self.Title_lbl.grid(row=0, column=0, pady=2, padx=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.Settings_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew", padx=2, pady=2)

        self.Customisation_btn = TK.Button(self.Settings_fr, bg=self.Btn_Background, foreground=self.Foreground,
                                           font=self.Font, text="Customisation", activebackground=self.Btn_Active, command=lambda: self.Customisation())
        self.Customisation_btn.grid(
            row=2, column=0, sticky="nsew", padx=2, pady=2)

        self.Account_btn = TK.Button(self.Settings_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                     foreground=self.Foreground, font=self.Font, text="Account", command=lambda: self.AccountSettings())
        self.Account_btn.grid(row=3, column=0, padx=2, pady=2, sticky="nsew")

        self.ReportBug_btn = TK.Button(self.Settings_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                       foreground=self.Foreground, font=self.Font, text="Report Bug", command=lambda: self.BugReport())
        self.ReportBug_btn.grid(row=4, column=0, padx=2, pady=2, sticky="nsew")

        self.Other_btn = TK.Button(self.Settings_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                   foreground=self.Foreground, font=self.Font, text="Other", command=lambda: self.OtherSettings())
        self.Other_btn.grid(row=5, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl1 = TK.Label(
            self.Settings_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl1.grid(row=6, column=0, sticky="nsew", padx=2, pady=2)

        self.Back_btn = TK.Button(self.Settings_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.Settings_fr, 1))
    ...
    def BugReport(self):
        ...
        self.Title_lbl = TK.Label(self.BugReport_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Bug Reporter:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=2)

        self.Space_lbl = TK.Label(
            self.BugReport_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)

        self.Bug_lbl = TK.Label(self.BugReport_fr, bg=self.Background,
                                foreground=self.Foreground, font=self.Font, text="Bug details:")
        self.Bug_lbl.grid(row=2, column=0, sticky="nsew", padx=2, pady=2)

        self.Bug_ent = TK.Entry(
            self.BugReport_fr, foreground=self.Foreground, font=self.Font)
        self.Bug_ent.grid(row=2, column=1, padx=2, pady=2, sticky="nsew")

        self.Space_lbl1 = TK.Label(
            self.BugReport_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl1.grid(row=3, column=0, sticky="nsew",
                             padx=2, pady=2, columnspan=2)

        self.Back_btn = TK.Button(self.BugReport_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.BugReport_fr, 2))
        self.Back_btn.grid(row=4, column=0, sticky="nsew", padx=2, pady=2)

        self.Report_btn = TK.Button(self.BugReport_fr, bg=self.PositiveBtn_Background, activebackground=self.PositiveBtn_Active,
                                    foreground=self.Foreground, font=self.Font, command=lambda: self.ReportBug(), text="Report Bug")
    ...
    def ReportBug(self):
        ...
        if self.Bug == "":
            self.Space_lbl.config(
                text="Sorry- you didn't leave any details about the bug")
            return
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                ...
                # Creates the table
                self.Cur.execute(
                    "CREATE TABLE Bugs(ID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT)")
                for i in range(len(self.Columns)):  # Adds the kwargs to the table
                    self.Cur.execute("ALTER TABLE Bugs ADD COLUMN {ColumnName} TEXT".format(
                        ColumnName=str(self.Columns[i]), ))
                pass
            except Exception:  # If the databse or table already exist it will exit
                pass
            ...
            try:
                self.Cur.execute(
                    "INSERT INTO Bugs(Username, BugDetails) VALUES(?, ?)", (self.Username, self.Bug))
            except Exception:
                pass
    ...
    def Customisation(self):
        ...
        self.Title_lbl = TK.Label(self.Customisation_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Other:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=2)

        self.Space_lbl = TK.Label(
            self.Customisation_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)
        ...
        for i in self.Defults:
            ...
            self.Customisation_lbl = TK.Label(
                self.Customisation_fr, bg=self.Background, foreground=self.Foreground, font=self.Font, text=i)
            self.Customisation_lbl.grid(
                row=self.Counter, column=0, padx=2, pady=2, sticky="nsew")
        ...
        for i in self.Defults:
            self.Customisation_ent = TK.Entry(
                self.Customisation_fr, foreground=self.Foreground, font=self.Font)
            self.Customisation_ent.grid(
                row=self.Counter, column=1, padx=2, pady=2, sticky="nsew")
            self.CustomisationEntry_list.append(self.Customisation_ent)
            self.Counter += 1

        self.Space_lbl1 = TK.Label(
            self.Customisation_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl1.grid(row=13, column=0, sticky="nsew",
                             padx=2, pady=2, columnspan=2)

        self.ResetDefults_btn = TK.Button(self.Customisation_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                          font=self.Font, foreground=self.Foreground, text="Restore Defults", command=lambda: self.SetDefults())
        self.ResetDefults_btn.grid(
            row=14, column=0, sticky="nsew", padx=2, pady=2, columnspan=2)

        self.Back_btn = TK.Button(self.Customisation_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.Customisation_fr, 2))
        self.Back_btn.grid(row=15, column=0, sticky="nsew", padx=2, pady=2)

        self.Save_btn = TK.Button(self.Customisation_fr, bg=self.PositiveBtn_Background, foreground=self.Foreground, font=self.Font,
                                  activebackground=self.PositiveBtn_Active, text="Save Changes", command=lambda: self.SaveChanges_Customisation())
    ...
    def SaveChanges_Customisation(self):
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("Background")].get() != "":
            self.Background = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "Background")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("Foreground")].get() != "":
            self.Foreground = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "Foreground")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("Btn_Background")].get() != "":
            self.Btn_Background = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "Btn_Background")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("Btn_Active")].get() != "":
            self.Btn_Active = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "Btn_Active")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("QuitBtn_Background")].get() != "":
            self.QuitBtn_Background = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "QuitBtn_Background")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("QuitBtn_Active")].get() != "":
            self.QuitBtn_Active = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "QuitBtn_Active")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("PositiveBtn_Background")].get() != "":
            self.PositiveBtn_Background = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "PositiveBtn_Background")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("PositiveBtn_Active")].get() != "":
            self.PositiveBtn_Active = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "PositiveBtn_Active")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("Font")].get() != "":
            self.Font = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "Font")].get()
            self.UpdateState_Font(self.Customisation_fr)

        if self.CustomisationEntry_list[self.TypeOrder_list.index("TitleFont")].get() != "":
            self.TitleFont = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "TitleFont")].get()
        ...
        if self.CustomisationEntry_list[self.TypeOrder_list.index("SubTitleFont")].get() != "":
            self.SubTitleFont = self.CustomisationEntry_list[self.TypeOrder_list.index(
                "SubTitleFont")].get()
    ...
    def AccountSettings(self):
        ...
        self.Title_lbl = TK.Label(self.Account_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Account Settings:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.Account_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew", padx=2, pady=2)

        self.ChangeUsername_btn = TK.Button(self.Account_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                            foreground=self.Foreground, font=self.Font, text="Change Username", command=lambda: self.ChangeUsername())
        self.ChangeUsername_btn.grid(
            row=2, column=0, pady=2, padx=2, sticky="nsew")

        self.ChangePassword_btn = TK.Button(self.Account_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                            foreground=self.Foreground, font=self.Font, text="Change Password", command=lambda: self.ChangePassword())
        self.ChangePassword_btn.grid(
            row=3, column=0, sticky="nsew", padx=2, pady=2)

        self.AddEmail_btn = TK.Button(self.Account_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                      foreground=self.Foreground, font=self.Font, text="Add/Change Email", command=lambda: self.AddChangeEmail())
        self.AddEmail_btn.grid(row=4, column=0, padx=2, pady=2, sticky="nsew")

        self.DeleteAccount_btn = TK.Button(self.Account_fr, bg=self.QuitBtn_Background, activebackground=self.QuitBtn_Active,
                                           foreground=self.Foreground, font=self.Font, text="Delete Account", command=lambda: self.DeleteAccountGUI(self.Account_fr))
        self.DeleteAccount_btn.grid(
        ...
        self.Back_btn = TK.Button(self.Account_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.Account_fr, 2))
        self.Back_btn.grid(row=7, column=0, sticky="nsew", padx=2, pady=2)
    ...
    def DeleteAccountGUI(self, Frame):
        ...
        self.Confurmation_lbl = TK.Label(self.DeleteAccount_tl, bg=self.Background, foreground=self.Foreground, font=self.Font,
        ...
        self.ConfurmPassword_ent.grid(
            row=2, column=0, padx=2, pady=2, sticky="nsew", columnspan=2)
        self.ConfurmPassword_ent.focus()

        self.Confurmation_btn = TK.Button(self.DeleteAccount_tl, bg=self.QuitBtn_Background, activebackground=self.QuitBtn_Active,
                                          font=self.Font, text="DELETE ACCOUNT", command=lambda: self.DeleteAccount(Frame))
        self.Confurmation_btn.grid(
            row=4, column=1, padx=2, pady=2, sticky="nsew")

        self.Back_btn = self.AddButton(4, 0, self.DeleteAccount_tl, "Back")
        self.Back_btn.config(command=lambda: self.Destroy(
            self.DeleteAccount_tl) and self.Back(self.Account_fr, 2))

        self.ConfurmPassword_ent.bind(
            "<Return>", lambda e: self.DeleteAccount(Frame))
    ...
    def ChangeUsername(self):
        ...
        self.Title_lbl = TK.Label(self.ChangeUsername_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Change Username:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=2)

        self.Space_lbl = TK.Label(
            self.ChangeUsername_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)

        self.ChangeUsername_lbl = TK.Label(
            self.ChangeUsername_fr, bg=self.Background, foreground=self.Foreground, font=self.Font, text="New Username:")
        self.ChangeUsername_lbl.grid(
            row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.ChangeUsername_ent = TK.Entry(
            self.ChangeUsername_fr, foreground=self.Foreground, font=self.Font)
        self.ChangeUsername_ent.grid(
        ...
        self.Back_btn = TK.Button(self.ChangeUsername_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.ChangeUsername_fr, 3))
        self.Back_btn.grid(row=4, column=0, sticky="nsew", padx=2, pady=2)

        self.Save_btn = TK.Button(self.ChangeUsername_fr, bg=self.PositiveBtn_Background, foreground=self.Foreground, font=self.Font,
                                  activebackground=self.PositiveBtn_Active, text="Save Changes", command=lambda: self.SaveChanges_Username())
        self.Save_btn.grid(row=4, column=1, padx=2, pady=2, sticky="nsew")

        self.ChangeUsername_ent.bind(
            "<Return>", lambda e: self.SaveChanges_Username())
    ...
    def SaveChanges_Username(self):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                # Tests if the username already exists in the database
                self.Cur.execute(
                    "SELECT EXISTS (SELECT * FROM Users WHERE Username = ?)", ((self.NewUsername,)))
                for i in self.Cur:
                    for n in i:
                        if n == 1:  # 0 meand the username isn't there 1 means it already exists
                            # If the username already exists it will tell the userr and clear their inputs
                            ...
                            pass
                self.Cur.execute(
                    "UPDATE Users SET Username = ? WHERE Username = ?", (self.NewUsername, self.Username))
            except Exception:
                pass
    ...
    def ChangePassword(self):
        ...
        self.Title_lbl = TK.Label(self.ChangePassword_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Change Password:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=2)

        self.Space_lbl = TK.Label(
            self.ChangePassword_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)

        self.OldPassword_lbl = TK.Label(self.ChangePassword_fr, bg=self.Background,
                                        foreground=self.Foreground, font=self.Font, text="Old Password:")
        self.OldPassword_lbl.grid(
            row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.OldPassword_ent = TK.Entry(
            self.ChangePassword_fr, foreground=self.Foreground, font=self.Font, show="•")
        self.OldPassword_ent.grid(
            row=2, column=1, sticky="nsew", padx=2, pady=2)

        self.ChangePassword_lbl = TK.Label(
            self.ChangePassword_fr, bg=self.Background, foreground=self.Foreground, font=self.Font, text="New Password:")
        self.ChangePassword_lbl.grid(
            row=3, column=0, padx=2, pady=2, sticky="nsew")

        self.ChangePassword_ent = TK.Entry(
            self.ChangePassword_fr, foreground=self.Foreground, font=self.Font, show="•")
        self.ChangePassword_ent.grid(
            row=3, column=1, sticky="nsew", padx=2, pady=2)

        self.RepeatChangePassword_lbl = TK.Label(
            self.ChangePassword_fr, bg=self.Background, foreground=self.Foreground, font=self.Font, text="Repeat Password:")
        self.RepeatChangePassword_lbl.grid(
            row=4, column=0, padx=2, pady=2, sticky="nsew")

        self.RepeatChangePassword_ent = TK.Entry(
            self.ChangePassword_fr, foreground=self.Foreground, font=self.Font, show="•")
        self.RepeatChangePassword_ent.grid(
            row=4, column=1, sticky="nsew", padx=2, pady=2)

        self.Space_lbl1 = TK.Label(
            self.ChangePassword_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl1.grid(row=5, column=0, sticky="nsew",
                             padx=2, pady=2, columnspan=2)

        self.Back_btn = TK.Button(self.ChangePassword_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.ChangePassword_fr, 3))
        self.Back_btn.grid(row=6, column=0, sticky="nsew", padx=2, pady=2)

        self.Save_btn = TK.Button(self.ChangePassword_fr, bg=self.PositiveBtn_Background, foreground=self.Foreground, font=self.Font,
                                  activebackground=self.PositiveBtn_Active, text="Save Changes", command=lambda: self.SaveChanges_Password())
        self.Save_btn.grid(row=6, column=1, padx=2, pady=2, sticky="nsew")

        self.RepeatChangePassword_ent.bind(
            "<Return>", lambda e: self.SaveChanges_Password())
        self.ChangePassword_ent.bind(
            "<Return>", lambda e: self.SaveChanges_Password())
        self.OldPassword_ent.bind(
            "<Return>", lambda e: self.SaveChanges_Password())
    ...
    def SaveChanges_Password(self):
        ...
        self.RepeatPassword = Hash.Hash(
            str(self.RepeatChangePassword_ent.get()))
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                ...
                if self.UserPassword == self.OldPassword:
                    ...
                    self.Cur.execute(
                        "UPDATE Users SET Password = ? WHERE Username = ?", (self.NewPassword, self.Username))
                else:
                    self.Space_lbl.congfig(
                        text="This isn't the correct old password")
                    self.ChangePassword_ent.delete(0, 'end')
                    self.OldPassword_ent.delete(0, "end")
                    self.RepeatChangePassword_ent.delete(0, "end")
                    return
    ...
    def AddChangeEmail(self):
        ...
        self.Title_lbl = TK.Label(self.AddEmail_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Add/Change Email:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=2)

        self.Space_lbl = TK.Label(
            self.AddEmail_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)

        self.AddEmail_lbl = TK.Label(self.AddEmail_fr, bg=self.Background,
                                     foreground=self.Foreground, font=self.Font, text="New Email:")
        self.AddEmail_lbl.grid(row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.AddEmail_ent = TK.Entry(
            self.AddEmail_fr, foreground=self.Foreground, font=self.Font)
        ...
        self.Back_btn = TK.Button(self.AddEmail_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.AddEmail_fr, 3))
        self.Back_btn.grid(row=4, column=0, sticky="nsew", padx=2, pady=2)

        self.Save_btn = TK.Button(self.AddEmail_fr, bg=self.PositiveBtn_Background, foreground=self.Foreground, font=self.Font,
                                  activebackground=self.PositiveBtn_Active, text="Save Changes", command=lambda: self.SaveChanges_Email())
        self.Save_btn.grid(row=4, column=1, padx=2, pady=2, sticky="nsew")
    ...
    def SaveChanges_Email(self):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                self.Cur.execute(
                    "UPDATE Users SET Email = ? WHERE Username = ?", (self.NewEmail, self.Username))
            except Exception:
                pass
    ...
    def OtherSettings(self):
        ...
        self.Title_lbl = TK.Label(self.Other_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Other:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.Other_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew", padx=2, pady=2)

        self.Back_btn = TK.Button(self.Other_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.Other_fr, 2))
    ...
    def MainMenu_Help(self):
        ...
        self.Explaination_lbl = TK.Label(
            self.Help_tl, bg=self.Background, foreground=self.Foreground, font=self.Font, text=self.ExplainationText)
    ...
    def ToolsMenu(self):
        ...
        self.Title_lbl = TK.Label(self.ToolsMenu_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Tools:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.ToolsMenu_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew", padx=2, pady=2)
        ...
        self.Space_lbl1 = TK.Label(
            self.ToolsMenu_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl1.grid(row=self.EndRow_Value, column=0,
                             sticky="nsew", padx=2, pady=2)

        self.Back_btn = TK.Button(self.ToolsMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.ToolsMenu_fr, 1))
        self.Back_btn.grid(row=self.EndRow_Value+1, column=0,
                           sticky="nsew", padx=2, pady=2)
    ...
    def GamesMenu(self):
        ...
        self.Title_lbl = TK.Label(self.GamesMenu_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Games:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.GamesMenu_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew", padx=2, pady=2)
        ...
        for i in range(len(self.Files)):
            ...
            self.Tools_btn = TK.Button(self.GamesMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                       foreground=self.Foreground, font=self.Font, text=self.module_name, command=lambda Num=i: self.RunGame(Num))
            self.Tools_btn.grid(row=i+2, column=0, pady=2,
                                padx=2, sticky="nsew")
        ...
        self.Back_btn = TK.Button(self.GamesMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.GamesMenu_fr, 1))
        self.Back_btn.grid(row=self.EndRow_Value+1, column=0,
                           sticky="nsew", padx=2, pady=2)
    ...
    def Messages(self):
        ...
        self.Title_lbl = TK.Label(self.Messages_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Messages:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=3)

        self.Space_lbl = TK.Label(
            self.Messages_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                self.Cur.execute(
                    "SELECT Messages FROM Users WHERE Username = ?", (self.Username,))
                for i in self.Cur:
                    for n in i:
        ...
        for i in range(len(self.Message_list)):
            ...
            self.IndividualMessage_fr = TK.Frame(
                self.Messages_fr, bg=self.Background)
            self.IndividualMessage_fr.grid(row=i+2, column=0, columnspan=2)

            self.Message_txt = TK.Text(self.IndividualMessage_fr, bg=self.Background,
                                       foreground=self.Foreground, font=self.Font, height=3, width=25)
            self.Message_txt.grid(row=i, column=0, pady=2,
                                  sticky="nsew", columnspan=2)

            self.Message_txt.insert("end", "{Num}: {Message}".format(
                Num=i+1, Message=self.Message_list[i]))
            ...
            self.DeleteMessage_btn = TK.Button(self.Messages_fr, bg=self.QuitBtn_Background, activebackground=self.QuitBtn_Active,
                                               foreground=self.Foreground, font=self.Font, text="X", command=lambda Num=i: self.DeleteMessage(Num))
            self.DeleteMessage_btn.grid(
                row=i+2, column=2, padx=2, pady=2, sticky="nsew")

            if i == len(self.Message_list)-1:
                self.Space_lbl1 = TK.Label(
                    self.Messages_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
                self.Space_lbl1.grid(
                    row=i+3, column=0, sticky="nsew", padx=2, pady=2, columnspan=3)

                self.Back_btn = TK.Button(self.Messages_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                          font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.Messages_fr, 1))
                self.Back_btn.grid(row=i+4, column=0,
                                   sticky="nsew", padx=2, pady=2)

                self.NewMessage_btn = TK.Button(self.Messages_fr, bg=self.PositiveBtn_Background, activebackground=self.PositiveBtn_Active,
                                                foreground=self.Foreground, font=self.Font, text="New Message", command=lambda: self.NewMessage())
                self.NewMessage_btn.grid(
                    row=i+4, column=1, sticky="nsew", padx=2, pady=2, columnspan=2)
    ...
    def DeleteMessage(self, Num):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                ...
                self.Cur.execute(
                    "UPDATE Users SET Messages = ? WHERE Username = ?", (self.Message_list, self.Username))
            except Exception as Identifier:
                print(Identifier)
                pass
    ...
    def NewMessage(self):
        ...
        self.Title_lbl = TK.Label(self.NewMessage_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Other:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=2)

        self.Space_lbl = TK.Label(
            self.NewMessage_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)

        self.SendTo_lbl = TK.Label(self.NewMessage_fr, bg=self.Background,
                                   font=self.Font, foreground=self.Foreground, text="Send To:")
        self.SendTo_lbl.grid(row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.SendTo_ent = TK.Entry(
            self.NewMessage_fr, foreground=self.Foreground, font=self.Font)
        self.SendTo_ent.grid(row=2, column=1, padx=2, pady=2, sticky="nsew")

        self.Message_lbl = TK.Label(self.NewMessage_fr, bg=self.Background,
                                    foreground=self.Foreground, font=self.Font, text="Message:")
        self.Message_lbl.grid(row=3, column=0, pady=2, sticky="nsew")

        self.Message_txt = TK.Text(
            self.NewMessage_fr, font=self.Font, foreground=self.Foreground, height=4, width=20)
        ...
        self.Space_lbl1 = TK.Label(self.NewMessage_fr, bg=self.Background, foreground=self.Foreground,
                                   font=self.Font, text="Remeber to include your username in the message")
        self.Space_lbl1.grid(row=4, column=0, sticky="nsew",
                             padx=2, pady=2, columnspan=2)

        self.Back_btn = TK.Button(self.NewMessage_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.NewMessage_fr, 1))
        self.Back_btn.grid(row=5, column=0, sticky="nsew", padx=2, pady=2)

        self.Send_btn = TK.Button(self.NewMessage_fr, bg=self.PositiveBtn_Background, activebackground=self.PositiveBtn_Active,
                                  foreground=self.Foreground, font=self.Font, text="Send!", command=lambda: self.SendMessage())
    ...
    def SendMessage(self):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            try:
                self.Cur.execute(
                    "SELECT Messages FROM Users WHERE Username = ?", (self.TargetUser,))
                for i in self.Cur:
                    for n in i:
            ...
            try:
                self.Cur.execute("UPDATE Users SET Messages = ? WHERE Username = ?",
                                 (self.TargetMessage_list, self.TargetUser))
            except Exception as Identifier:
    ...
    def AdminMenu(self):
        ...
        self.Title_lbl = TK.Label(self.AdminMenu_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Admin Menu:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.AdminMenu_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, padx=2, pady=2, sticky="nsew")

        self.GiveWarning_btn = TK.Button(self.AdminMenu_fr, bg=self.Btn_Background, foreground=self.Foreground,
                                         font=self.Font, activebackground=self.Btn_Active, text="Give Warning", command=lambda: self.GiveWarning())
        self.GiveWarning_btn.grid(
            row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.viewBugs_btn = TK.Button(self.AdminMenu_fr, bg=self.Btn_Background, foreground=self.Foreground,
                                      activebackground=self.Btn_Active, font=self.Font, command=lambda: self.ViewBugs(), text="View Bugs")
        ...
        self.Back_btn = TK.Button(self.AdminMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  foreground=self.Foreground, font=self.Font, command=lambda: self.Back(self.AdminMenu_fr, 1), text="Back")
        self.Back_btn.grid(row=5, column=0, padx=2, pady=2, sticky="nsew")

        self.Align_Grid(self.AdminMenu_fr)

    def ViewBugs(self):
        # Displays all of the bugs to the admin
        ...
        self.Title_lbl = TK.Label(self.ViewBugs_fr, bg=self.Background,
                                  foreground=self.Foreground, text="Bug Viewer", font=self.TitleFont)
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.ViewBugs_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, padx=2, pady=2, sticky="nsew")
        ...
        for i in self.BugReports:
            self.BugDetail_btn = TK.Button(self.ViewBugs_fr, bg=self.Btn_Background, activebackground=self.Btn_Active, font=self.Font,
                                           foreground=self.Foreground, command=lambda Num=self.BugReports.index(i): self.BugDetails(Num), text=i[2])
            self.BugDetail_btn.grid(row=self.BugReports.index(
                i) + 2, column=0, sticky="nsew", padx=2, pady=2)
            ...
            if self.BugReports.index(i) == len(self.BugReports)-1:
                self.Space_lbl = TK.Label(
                    self.ViewBugs_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
                self.Space_lbl.grid(row=self.BugReports.index(
                    i) + 3, column=0, padx=2, pady=2, sticky="nsew")

                self.Back_btn = TK.Button(self.ViewBugs_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                          font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.ViewBugs_fr, 4))
                self.Back_btn.grid(row=self.BugReports.index(
                    i) + 4, column=0, sticky="nsew", padx=2, pady=2)

    def BugDetails(self, Num):
        # Loads the bug report
        self.BugNumber = Num
        ...
        self.BugTitle_lbl = TK.Label(self.BugDetails_fr, bg=self.Background,
                                     foreground=self.Foreground, font=self.Font, text=self.BugReports[Num][2])
        self.BugTitle_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(self.BugDetails_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.Font, text=self.BugReports[self.BugNumber][3])
        self.Space_lbl.grid(row=1, column=0, padx=2, pady=2, sticky="nsew")
        ...
        # Sets the buttons which change the bugs status or delete it
        self.SetImportant_btn = TK.Button(self.Button_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                          foreground=self.Foreground, font=self.Font, command=lambda: self.UpdateStatus("Important"), text=" ! ")
        self.SetImportant_btn.grid(
            row=0, column=0, sticky="nsew", padx=2, pady=2)

        self.SetFixing_btn = TK.Button(self.Button_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                       foreground=self.Foreground, font=self.Font, text="Fixing", command=lambda: self.UpdateStatus("Fixing"))
        self.SetFixing_btn.grid(row=0, column=1, sticky="nsew", padx=2, pady=2)

        self.DeleteReport_btn = TK.Button(self.Button_fr, bg=self.QuitBtn_Background, foreground=self.Foreground,
                                          activebackground=self.QuitBtn_Active, text=" X ", font=self.Font, command=lambda: self.DeleteBugReport())
        self.DeleteReport_btn.grid(
            row=0, column=2, pady=2, padx=2, sticky="nsew")

        self.Back_btn = TK.Button(self.BugDetails_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.BugDetails_fr, 5))
        self.Back_btn.grid(row=4, column=0, sticky="nsew", padx=2, pady=2)
    ...
    def UpdateStatus(self, Status):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            self.Cur = self.Con.cursor()
            try:
                self.Cur.execute("UPDATE Bugs SET Status = ? WHERE ID = ?", (str(
                    Status), self.BugReports[self.BugNumber][0]))
            except Exception as Identifier:
                print(Identifier)
                return
    ...
    def DeleteBugReport(self):
        # Delets the bug from the report

        # Connects to the database
        with lite.connect("myDatabase.db") as self.Con:
            # Creats a curser object
            self.Cur = self.Con.cursor()
            try:
                # Deletes the bug
                self.Cur.execute("DELETE FROM Bugs WHERE ID = ?",
                                 (self.BugReports[self.BugNumber][0],))
            except Exception as Identifier:
                print(Identifier)
                return
    ...
    def GiveWarning(self):
        ...
        self.Title_lbl = TK.Label(self.GiveWarning_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Give Warnings")
        self.Title_lbl.grid(row=0, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)

        self.Space_lbl = TK.Label(
            self.GiveWarning_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, padx=2, pady=2,
                            sticky="nsew", columnspan=2)

        self.WarnedUser_lbl = TK.Label(self.GiveWarning_fr, bg=self.Background,
                                       foreground=self.Foreground, font=self.Font, text="Username:")
        self.WarnedUser_lbl.grid(
            row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.WarnedUser_ent = TK.Entry(
            self.GiveWarning_fr, foreground=self.Foreground, font=self.Font)
        self.WarnedUser_ent.grid(
            row=2, column=1, padx=2, pady=2, sticky="nsew")
        self.WarnedUser_ent.focus()

        self.Space_lbl1 = TK.Label(
            self.GiveWarning_fr, foreground=self.Foreground, font=self.Font, bg=self.Background)
        self.Space_lbl1.grid(row=3, column=0, columnspan=2,
                             padx=2, pady=2, sticky="nsew")

        self.WarnUser_btn = TK.Button(self.GiveWarning_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                      foreground=self.Foreground, font=self.Font, text="Give Warning", command=lambda: self.WarnUser())
        self.WarnUser_btn.grid(row=4, column=0, columnspan=2,
                               padx=2, pady=2, sticky="nsew")

        self.Back_btn = TK.Button(self.GiveWarning_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  font=self.Font, foreground=self.Foreground, text="Back", command=lambda: self.Back(self.GiveWarning_fr, 4))
        self.Back_btn.grid(row=5, column=0, columnspan=2,
                           padx=2, pady=2, sticky="nsew")
    ...
    # Will add a warning to the users accout which will display when they login
    # If a user gets more then 3 warnings there account will be deleted
    def WarnUser(self):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            ...
            self.Cur = self.Con.cursor()
            try:
                # Reads the users current number of warnings
                self.Cur.execute(
                    "SELECT Warnings FROM Users WHERE UserName = ?", (self.WarnedUsername,))

                try:
                    # Adds one to the number of warnings
                    ...
                    self.Cur.execute(
                        "UPDATE Users SET Warnings = ? WHERE UserName = ?", (self.NumWarnings, self.WarnedUsername))
                except TypeError:
                    pass
            except Exception as Identifier:
                print(Identifier)

    # Loads the owners menu GUI
    def OwnerMenu(self):
        self.MainMenu_fr.destroy()
        self.OwnerMenu_fr = TK.Frame(self.Main_fr, bg=self.Background)
        self.OwnerMenu_fr.pack(fill=TK.BOTH, expand=True)

        self.Title_lbl = TK.Label(self.OwnerMenu_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Owner Menu:")
        self.Title_lbl.grid(row=0, column=0, padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.OwnerMenu_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, padx=2, pady=2, sticky="nsew")

        self.ChangeAccountType_btn = TK.Button(self.OwnerMenu_fr, bg=self.Btn_Background, foreground=self.Foreground, font=self.Font,
                                               activebackground=self.Btn_Active, text="Change Account Type", command=lambda: self.ChangeAccountType_GUI())
        self.ChangeAccountType_btn.grid(
            row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.DeleteUserAccount_btn = TK.Button(self.OwnerMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                               foreground=self.Foreground, font=self.Font, text="Delete Account", command=lambda: self.DeleteUserAccount())
        self.DeleteUserAccount_btn.grid(
            row=3, column=0, sticky="nsew", padx=2, pady=2)
        ...
        self.Back_btn = TK.Button(self.OwnerMenu_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  foreground=self.Foreground, font=self.Font, command=lambda: self.Back(self.OwnerMenu_fr, 1), text="Back")
        self.Back_btn.grid(row=5, column=0, padx=2, pady=2, sticky="nsew")

        self.Align_Grid(self.OwnerMenu_fr)

    # The GUI for the owner to delete a users account
    def DeleteUserAccount(self):
        ...
        self.Title_lbl = TK.Label(self.DeleteUserAccount_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Delete User Account:")
        self.Title_lbl.grid(row=0, column=0, columnspan=2,
                            padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.DeleteUserAccount_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, columnspan=2, padx=2, pady=2)

        self.TargetUser_lbl = TK.Label(self.DeleteUserAccount_fr, bg=self.Background,
                                       foreground=self.Foreground, font=self.Font, text="Username:")
        self.TargetUser_lbl.grid(
            row=2, column=0, padx=2, pady=2, sticky="nsew")

        self.TargetUser_ent = TK.Entry(
            self.DeleteUserAccount_fr, foreground=self.Foreground, font=self.Font)
        self.TargetUser_ent.grid(
            row=2, column=1, padx=2, pady=2, sticky="nsew")

        self.Space_lbl1 = TK.Label(
            self.DeleteUserAccount_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl1.grid(row=3, padx=2, pady=2,
                             column=0, columnspan=2, sticky="nsew")

        self.ConfurmDeleteUserAccount_btn = TK.Button(self.DeleteUserAccount_fr, bg=self.QuitBtn_Background, activebackground=self.QuitBtn_Active,
                                                      foreground=self.Foreground, font=self.Font, text="Delete Account", command=lambda: self.DeleteUserAccountAction())
        self.ConfurmDeleteUserAccount_btn.grid(
            row=4, column=1, padx=2, pady=2, sticky="nsew")

        self.Back_btn = TK.Button(self.DeleteUserAccount_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  foreground=self.Foreground, font=self.Font, command=lambda: self.Back(self.DeleteUserAccount_fr, 6), text="Back")
    ...
    def DeleteUserAccountAction(self):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            self.Cur = self.Con.cursor()
            try:
                self.Cur.execute("DELETE FROM Users WHERE Username = ?",
                                 (Hash.Hash(str(self.TargetUser_ent.get())),))
            except Exception as Identifier:
                self.Space_lbl.config(text=Identifier)
        self.Back(self.DeleteUserAccount_fr, 6)

    # Will allow the owner to change another users account type
    def ChangeAccountType_GUI(self):
        ...
        self.Title_lbl = TK.Label(self.ChangeAccountType_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Change Account Types:")
        self.Title_lbl.grid(row=0, column=0, columnspan=2,
                            padx=2, pady=2, sticky="nsew")

        self.Space_lbl = TK.Label(
            self.ChangeAccountType_fr, bg=self.Background, font=self.Font, foreground=self.Foreground)
        self.Space_lbl.grid(row=1, column=0, columnspan=2,
                            sticky="nsew", padx=2, pady=2)

        self.TargetUsername_lbl = TK.Label(
            self.ChangeAccountType_fr, bg=self.Background, font=self.Font, foreground=self.Foreground, text="Username:")
        self.TargetUsername_lbl.grid(
            row=2, padx=2, pady=2, sticky="nsew", column=0)

        self.TargetUsername_ent = TK.Entry(
            self.ChangeAccountType_fr, foreground=self.Foreground, font=self.Font)
        self.TargetUsername_ent.grid(
            row=2, column=1, padx=2, pady=2, sticky="nsew")

        self.AccountType_lbl = TK.Label(self.ChangeAccountType_fr, bg=self.Background,
                                        font=self.Font, foreground=self.Foreground, text="Account Type:")
        self.AccountType_lbl.grid(
            row=3, column=0, sticky="nsew", padx=2, pady=2)

        self.StrVar = TK.StringVar(self.ChangeAccountType_fr)
        self.StrVar.set("standered")

        self.AccountType_dd = TK.OptionMenu(
            self.ChangeAccountType_fr, self.StrVar, "standered", "admin", "owner", "higher")
        self.AccountType_dd.config(bg=self.Background, foreground=self.Foreground,
                                   font=self.Font, activebackground=self.Background)
        self.AccountType_dd["menu"].config(
            bg=self.Background, foreground=self.Foreground, font=self.Font, activebackground=self.Background)
        self.AccountType_dd["highlightthickness"] = 0
        self.AccountType_dd.grid(
            row=3, column=1, padx=2, pady=2, sticky="nsew")

        self.Space_lbl1 = TK.Label(
            self.ChangeAccountType_fr, bg=self.Background, font=self.Font, foreground=self.Foreground)
        self.Space_lbl1.grid(row=4, column=0, columnspan=2,
                             sticky="nsew", padx=2, pady=2)

        self.ConfurmChangeAccountType_btn = TK.Button(self.ChangeAccountType_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                                      foreground=self.Foreground, font=self.Font, text="Change Account", command=lambda: self.ChangeAccountType())
        self.ConfurmChangeAccountType_btn.grid(
            row=5, column=1, padx=2, pady=2, sticky="nsew")

        self.Back_btn = TK.Button(self.ChangeAccountType_fr, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                  foreground=self.Foreground, font=self.Font, command=lambda: self.Back(self.ChangeAccountType_fr, 6), text="Back")
        self.Back_btn.grid(row=5, column=0, padx=2, pady=2, sticky="nsew")
    ...
    def Help(self):
        ...
        self.Help_lbl = TK.Label(self.Help_tl, bg=self.Background,
                                 foreground=self.Foreground, font=self.Font, text=self.HelpStr)
        self.Help_lbl.grid(row=0, column=0, sticky="nsew", padx=2, pady=2)

        self.PasswordReset_btn = TK.Button(self.Help_tl, bg=self.Btn_Background, activebackground=self.Btn_Active,
                                           text="Reset Password", font=self.Font, foreground=self.Foreground, command=lambda: self.ResetPassword())
        self.PasswordReset_btn.grid(
    ...
    def ResetPassword(self):
        # GUI behind the password reset system
        ...
        self.Title_lbl = TK.Label(self.ResetPassword_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.TitleFont, text="Reset Password")
        self.Title_lbl.grid(row=0, column=0, columnspan=2,
                            sticky="nsew", padx=2, pady=2)

        self.Space_lbl = TK.Label(
            self.ResetPassword_fr, bg=self.Background, foreground=self.Foreground, font=self.Font)
        self.Space_lbl.grid(row=1, column=0, sticky="nsew",
                            padx=2, pady=2, columnspan=2)
        ...
        self.Explaination_lbl = TK.Label(self.ResetPassword_fr, bg=self.Background,
                                         foreground=self.Foreground, font=self.Font, text=self.ExplainationText)
        self.Explaination_lbl.grid(
            row=2, column=0, columnspan=2, padx=2, pady=2)

        self.Username_lbl = TK.Label(self.ResetPassword_fr, bg=self.Background,
                                     foreground=self.Foreground, font=self.Font, text="Username:")
        self.Username_lbl.grid(row=3, column=0, sticky="nsew", padx=2, pady=2)

        self.Username_ent = TK.Entry(
            self.ResetPassword_fr, foreground=self.Foreground, font=self.Font)
        self.Username_ent.grid(row=3, column=1, sticky="nsew", padx=2, pady=2)
        self.Username_ent.focus()

        self.Email_lbl = TK.Label(self.ResetPassword_fr, bg=self.Background,
                                  foreground=self.Foreground, font=self.Font, text="Email:")
        ...
        self.ResetPassword_btn = TK.Button(self.Button_fr, bg=self.PositiveBtn_Background, foreground=self.Foreground,
                                           activebackground=self.PositiveBtn_Active, font=self.Font, text="Reset Password", command=lambda: self.PasswordReset())
        self.ResetPassword_btn.grid(
            row=0, column=1, sticky="nsew", padx=2, pady=2)
        ...
        self.Back_btn = TK.Button(self.Button_fr, bg=self.Btn_Background, activebackground=self.Btn_Active, font=self.Font,
                                  foreground=self.Foreground, text="Back", command=lambda: self.Back(self.ResetPassword_fr, 0))
        self.Back_btn.grid(row=0, column=2, sticky="nsew", padx=2, pady=2)
    ...
    def PasswordReset(self):
        ...
        with lite.connect("myDatabase.db") as self.Con:
            # Creats a curser object
            self.Cur = self.Con.cursor()
            # Finds the email stored in the database
            try:
                self.Cur.execute(
                    "SELECT Email FROM Users WHERE Username = ?", ((self.Username,)))
                self.UsersEmail = self.Cur.fetchall()[0][0]
            except Exception:
                # It it cannot find the email it tells the user it dosn't exist
                self.Space_lbl.config(
                    text="Sorry this username dosn't have an email associated with it")
                self.Username_ent.focus()
                self.Username_ent.delete(0, "end")
                self.Email_ent.delete(0, "end")
                # Stops the code running any further
                return

        # Checks the email agaist the one in the database
        if self.UsersEmail == self.Email:
            from random import randint
            # Generates a random number to act as a temperary password
            self.RandomNum = randint(10000, 100000)

            # Sends the user an email with there new password
            Email.Email(str(self.Email_ent.get()), NewPassword=self.RandomNum)

            with lite.connect("myDatabase.db") as self.Con:
                self.Cur = self.Con.cursor()
                try:
                    # Sets the users password to the random numbers sent over the email
                    self.Cur.execute("UPDATE Users SET Password = ? WHERE Username = ?", (Hash.Hash(
                        self.RandomNum), self.Username))
                except Exception as Identifier:
                    print(Identifier)

            self.Space_lbl.config(
                text="You new password has been successfully sent!")
            self.Username_ent.delete(0, 'end')
            self.Email_ent.delete(0, 'end')
            return
        else:
            self.Space_lbl.config(
                text="Sorry that email wasn't the one in our database")
            self.Username_ent.delete(0, 'end')
            self.Email_ent.delete(0, 'end')
            return
